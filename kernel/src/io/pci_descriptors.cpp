...
namespace PCI {
    ...
    // From a known vendor id to the vendor's name
    ...
    // Get the device name from a known vendor id and device id
    ...
    // Get subclass from code for mass storage controllers
    ...
    // Get subclass name from subclass code for serial bus controllers
    ...
    // Get subclass name from subclass code for bridge devices
    ...
    // Get the subclass name for a classes' subclass
    ...
    // Get the program interface name for a class, subclass and program interface code
